...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val buttonNotDependOnColor = view.findViewById<Button>(R.id.not_depend_color_button)
        buttonNotDependOnColor.setOnClickListener(Navigation.createNavigateOnClickListener(
                R.id.action_homeFragment_to_notDependOnColorFragment, null))

        val buttonDescriptionRedundancy = view.findViewById<Button>(R.id.description_redundancy_button)
        buttonDescriptionRedundancy.setOnClickListener(Navigation.createNavigateOnClickListener(
                R.id.action_homeFragment_to_descriptionRedundancyFragment, null))

        val buttonLocalizingString = view.findViewById<Button>(R.id.localizing_string_button)
        buttonLocalizingString.setOnClickListener(Navigation.createNavigateOnClickListener(
                R.id.action_homeFragment_to_localizingStringFragment, null))
    }
}
